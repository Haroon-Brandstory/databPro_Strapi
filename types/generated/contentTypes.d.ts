...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    socialPlatform: Schema.Attribute.Component<
...
export interface ApiCompanyDataCompanyData extends Struct.CollectionTypeSchema {
  collectionName: 'companies_data';
  info: {
    displayName: 'company data';
    pluralName: 'companies-data';
    singularName: 'company-data';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    address: Schema.Attribute.Component<'industry.address', true>;
    ...
    SubIndustry: Schema.Attribute.String;
...
export interface ApiServiceUnderCategoryServiceUnderCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'service_under_categories';
  info: {
    displayName: 'Service under category';
    pluralName: 'service-under-categories';
    singularName: 'service-under-category';
  };
  options: {
    draftAndPublish: true;
  };
